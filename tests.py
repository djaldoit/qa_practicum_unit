...
# создаем экземпляр BooksCollector
...
class TestBooksCollector:
    ...
    def test_add_new_book_name_book_more_41_symbols(self):
        ...
        collector.add_new_book('Тестовая книга 1')
        collector.add_new_book('Тестовая книга 2Тестовая книга 2Тестовая книга 2')
        assert collector.get_books_genre() == {'Тестовая книга 1': ''}
    ...
    def test_get_books_get_dictionary(self):
        ...
        collector.add_new_book('Тестовая книга 1')
        collector.add_new_book('Тестовая книга 2')
        assert collector.get_books_genre() == {'Тестовая книга 1': '', 'Тестовая книга 2': ''}
    ...
    def test_get_books_for_children_no_age_rating(self):
        ...
        collector.genre_age_rating = ['Детективы']
